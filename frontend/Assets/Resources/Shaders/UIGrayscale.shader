Shader "Memotopia/UIGrayscale"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            struct appdata { float4 vertex : POSITION; float4 color : COLOR; float2 texcoord : TEXCOORD0; UNITY_VERTEX_INPUT_INSTANCE_ID };
            ...
            v2f vert(appdata v)
            {
                ...
                o.texcoord = v.texcoord; o.color = v.color * _Color;
                return o;
            }
